...
// clang-format off
    ...
    xf::cv::preProcess<TYPE, XF_32FC1, NEWHEIGHT, NEWWIDTH, NPC_T, WIDTH_A, IBITS_A, WIDTH_B, IBITS_B, WIDTH_OUT,
                       IBITS_OUT>(resize_out_mat, in_mat, params);
    xf::cv::xfMat2Array<OUTPUT_PTR_WIDTH, TYPE, NEWHEIGHT, NEWWIDTH, NPC_T, XF_CV_DEPTH_IN>(in_mat, img_out);
}
